...
export default function MessagesDashboard({ userName, userRole }) {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-6 px-4 sm:px-6 font-['Raleway',sans-serif] flex flex-col h-[calc(100vh-160px)]">
      
      {/* Dynamic Context Header */}
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-white tracking-tight">Blue Sky Travel</h2>
        <p className="text-sm text-gray-400 font-medium">Booking Engine Redesign</p>
      </div>

      {/* Main Interface Grid Split */}
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 min-h-0">
        
        {/* Active Chats Sidebar Panel (1 Column) */}
        <div className="p-4 rounded-[5px] bg-[#1c1a17]/50 border border-white/10 backdrop-blur-md shadow-2xl flex flex-col h-full">
        ...
        {/* Interactive Chat Stream Panel (2 Columns) */}
        <div className="md:col-span-2 p-4 rounded-[5px] bg-[#1c1a17]/50 border border-white/10 backdrop-blur-md shadow-2xl flex flex-col h-full">
          ...
          <div className="bg-[#d9d5ce] rounded-[5px] p-5 flex-1 overflow-y-auto text-xs space-y-4 flex flex-col text-black">
            ...
            <div className="self-center my-1">
              <span className="bg-black/10 text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-[5px] text-gray-600">
                Today
              </span>
            </div>
            ...
            <div className="flex gap-3 max-w-[85%]">
              ...
              <div>
                ...
                <span className="text-[9px] font-bold text-gray-500 ml-1 mt-1 block">Zain • 10:45 AM</span>
              </div>
            </div>

            {/* Outbound Message Row (Gradient) */}
            <div className="flex flex-col items-end max-w-[85%] self-end">
              ...
              <span className="text-[9px] font-bold text-gray-500 mr-1 mt-1 block">You • 10:48 AM</span>
            </div>
            ...
            <div className="flex gap-3 max-w-[85%]">
              ...
              <div>
                ...
                <span className="text-[9px] font-bold text-gray-500 ml-1 mt-1 block">Zain • 10:50 AM</span>
              </div>
            </div>
          ...
          <div className="mt-4 bg-black rounded-[5px] p-2.5 flex items-center gap-3 border border-white/10">
            <button className="text-gray-400 hover:text-white pl-1.5 transition-colors text-lg cursor-pointer">
              📎
            </button>
            <input 
              type="text" 
              placeholder="Write a message..." 
              className="bg-transparent text-xs text-white placeholder-gray-500 outline-none flex-1 font-medium"
            />
            <div className="flex items-center gap-2">
              <button className="text-gray-400 hover:text-white transition-colors text-base cursor-pointer">
                色彩
              </button>
