        ...
        <div className="bg-[#FFF6E9] dark:bg-[#1c1a17]/70 border border-black/5 dark:border-white/10 rounded-[14px] p-6 sm:p-8 backdrop-blur-xl shadow-lg dark:shadow-2xl transition-all duration-300 space-y-5 text-center">
          ...
          <form onSubmit={handleLogin} className="space-y-3.5">
            ...
            <div className="text-left space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-white dark:bg-[#000000]/40 border border-gray-300 dark:border-white/10 rounded-[6px] h-9.5 pl-9 pr-9 text-xs text-gray-900 dark:text-[#FFFFFF] placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-[#DC6B0F] transition-colors duration-300 font-medium shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)]"
                  value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#F2A508] via-[#DC6B0F] to-[#BD1C22] text-white h-9.5 rounded-[6px] font-extrabold text-xs tracking-wider shadow-sm active:scale-[0.99] hover:brightness-105 transition-all uppercase cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
